...
namespace PluginCore.Infrastructure
{
    ...
    /// </summary>
    public static class PluginsLoadContexts<TCollectibleAssemblyLoadContext>
        where TCollectibleAssemblyLoadContext : CollectibleAssemblyLoadContext, ICollectibleAssemblyLoadContext
    {
        #region Fields

        private static Dictionary<string, TCollectibleAssemblyLoadContext>
            _pluginContexts;
        ...
        {
            _pluginContexts = new Dictionary<string, TCollectibleAssemblyLoadContext>();
        }
        #endregion

        #region Methods
        public static List<TCollectibleAssemblyLoadContext> All()
        {
        ...
        public static TCollectibleAssemblyLoadContext Get(string pluginId)
        {
            return _pluginContexts[pluginId];
        }

        public static void Add(string pluginId,
             TCollectibleAssemblyLoadContext context)
        {
