...
namespace PluginCore.lmplements
{
    ...
    /// </remarks>
    public class PluginFinderV2 : IPluginFinder
    {
        #region Fields
        ...
        #region Ctor
        public PluginFinderV2(IPluginContextManager pluginContextManager, IServiceScopeFactory serviceScopeFactory)
        {
            this.PluginContextManager = pluginContextManager;
            _serviceScopeFactory = serviceScopeFactory;
        }

        static PluginFinderV2()
        {
